...
class Event extends MyBaseModel
{
     ...
     */
    protected $messages = [
        'title.required'                       => 'Event.errors.title_required',
        'organiser_name.required_without'      => 'Event.errors.organiser_name_required_without',
        'event_image.mimes'                    => 'Event.errors.event_image_mimes',
        'event_image.max'                      => 'Event.errors.event_image_max',
        'location_venue_name.required_without' => 'Event.errors.location_venue_name_required_without',
        'venue_name_full.required_without'     => 'Event.errors.venue_name_full_required_without',
    ];
    ...
    public function rules()
    {
        ...
        return [
            ...
            'event_image'         => 'nullable|mimes:jpeg,jpg,png|max:30720',
        ];
    }
